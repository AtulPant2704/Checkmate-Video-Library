            ...
            <div className="singlePlaylist-page">
                ...
                <section className="singlePlaylistVideo-section">
                    <div className="singlePlaylistVideo-intro">
                        ...
                        <button className="btn btn-text-icon btn-text-icon-primary delete-playlist-btn" onClick={callDeletePlaylistHandler}><i className="fas fa-trash-alt"></i> Delete</button>
                    </div>
                    <div className="singlePlaylistVideos-container">
                        {playlist ?
                            playlist.videos.map(item => (
                                <HorizontalVideoCard key={item._id} {...item} playlistID={playlistID} setPlaylist={setPlaylist} />
                            )) : null}
                    </div>
                </section>
            </div>
